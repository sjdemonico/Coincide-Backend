...
xst -ifn xst.scr
move medclk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\medclk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc medclk_exdes.ucf medclk_exdes

echo 'Running map'
map -timing -pr b medclk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm medclk_exdes -w routed.ncd routed.v
cd ..
