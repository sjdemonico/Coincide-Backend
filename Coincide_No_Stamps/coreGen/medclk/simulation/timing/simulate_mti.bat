...
vlog -work work medclk_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax medclk_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.medclk_tb work.glbl
