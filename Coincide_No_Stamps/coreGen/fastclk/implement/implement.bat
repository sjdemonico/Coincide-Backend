...
xst -ifn xst.scr
move fastclk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\fastclk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc fastclk_exdes.ucf fastclk_exdes

echo 'Running map'
map -timing -pr b fastclk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm fastclk_exdes -w routed.ncd routed.v
cd ..
