...
vlog -work work fastclk_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax fastclk_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.fastclk_tb work.glbl
