...
module mojo_top_0 (
  ...
  localparam X_PULSE_LEN = 2'h2;
  
  localparam Y_PULSE_LEN = 4'hf;
  ...
  always @* begin
    ...
    if (M_tmr_maxval) begin
      for (i = 1'h0; i < 5'h1e; i = i + 1) begin
        M_count_store_d[(i)*23+22-:23] = M_counts_q[(i)*23+22-:23];
